...
def cert_maker(participant_name, event_type, event_title, department, event_description, event_date, gdg_lead, lead_name, colead_name):
    ...
    draw_text(draw, participant_name, 85, 258, 623, 48, "bold", multiline=False)
    draw_text(draw, "has successfully participated in the " + event_type, 200, 356, 402, 12, "medium", multiline=False)
    draw_text(draw, event_title, 6, 379, 780, 20, "bold", multiline=False)
    draw_text(draw, "organized by the " + department, 256, 411, 282, 12, "medium", multiline=False)
    draw_text(draw, event_description, 136, 437, 520, 10, "medium", multiline=True)
    draw_text(draw, "Awarded on " + event_date, 296, 487, 201, 13, "medium", multiline=False)
    draw_text(draw,  gdg_lead, 154, 534, 133, 13, "bold", multiline=False)
    draw_text(draw,  "GDG PUP President and Chapter Lead" , 170, 550, 102, 8, "medium", multiline=True)
    draw_text(draw,  lead_name, 292, 537, 198, 13, "bold", multiline=False)
    draw_text(draw,  "GDG PUP " + "Cybersecurity " + "Lead", 336.55, 555.96, 107.91, 8, "medium", multiline=False)
    draw_text(draw,  colead_name, 501, 537, 121, 13, "bold", multiline=False)
    draw_text(draw,  "GDG PUP " + "Cybersecurity " + "Co-Lead", 500, 554, 122, 8, "medium", multiline=False)
